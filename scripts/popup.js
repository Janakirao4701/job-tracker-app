...
function renderNotLoggedIn() {
  document.getElementById('root').innerHTML = `
    <div class="get-started">
      <div class="gs-icon"><img src="../icons/icon-128.png" style="width:40px; height:40px; object-fit:contain; border-radius:10px;"/></div>
  ...
  document.getElementById('root').innerHTML = `
    <div class="header">
      ...
      <div class="header-top">
        <div class="logo"><img src="../icons/icon-48.png" style="width:24px; height:24px; object-fit:contain; border-radius:6px;"/></div>
